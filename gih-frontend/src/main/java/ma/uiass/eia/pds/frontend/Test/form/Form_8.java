...
public class Form_8 extends javax.swing.JPanel {
    ...
    OkHttp o = new OkHttp();
    List<Emplacement> emplacements = o.getEmplacements();
    ...
    private void initComponents() {
        ...
        tableModel.setColumnIdentifiers(new String[]{"Code", "Nom", "Etage"});
    ...
    private void loadLits(DefaultTableModel tableModel) {
        ...
        for (Emplacement emplacement : emplacements) {
            Object[] row = new Object[]{emplacement.getCode(), emplacement.getNomBatiment(), emplacement.getEtage()};
